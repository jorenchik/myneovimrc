...
See `:help mapleader` `:help lazy.nvim.txt`
...
require('lazy').setup({
    ...
    { 'dense-analysis/ale' },
    {
        ...
        config = function()
            ...
            vim.keymap.set('i', '<M-CR>', function() return vim.fn['codeium#Complete']() end,
...
-- Save from insert and outside mode
...
vim.api.nvim_set_keymap('n', '<Leader>ex', ':NERDTreeToggle<CR>', { noremap = true, silent = true })

-- vim.api.nvim_set_keymap('n', '<Leader>ex', ':Vifm .<CR>', { noremap = true, silent = true })
